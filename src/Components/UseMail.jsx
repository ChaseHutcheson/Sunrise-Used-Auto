  ...
  return (
    ...
    >
      ...
      <div className="mb-3 pt-0 flex flex-col items-center">
        <button
          className="bg-blue-500 text-white active:bg-blue-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mt-5 mb-1 ease-linear transition-all duration-150"
          type="submit"
        >
          Send a message
        </button>
