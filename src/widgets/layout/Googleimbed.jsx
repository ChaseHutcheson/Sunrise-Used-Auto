...
const Googleimbed = () => (
    <div className="flex flex-col pt-10 pr-14 pb-0 pl-14">
            <div className="float-left rounded-2xl bg-blue-50 h-96 w-96 items-center">
                <div className="text-4xl text-center pt-10 pr-3 pl-3 pb-0.5 font-semibold mt-6">
                    Canfield
                </div>
                <div className="text-center text-2xl pb-6 pt-2 text-gray-600 font-semibold">
                    7300 N Palmyra Rd, Canfield, OH 44406
                </div>
                <div className="text-4xl text-center pt-3 pr-3 pl-3 pb-0.5 fw font-semibold">
                    Hours of Operation
                </div>
